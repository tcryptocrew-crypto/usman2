...
const Footer = () => {
  return (
    <footer className="relative bg-black py-12 overflow-hidden">
      {/* Gradient Background */}
      <div className="absolute inset-0 bg-gradient-to-t from-yellow-900/10 via-black to-black" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="relative">
            ...
            <div className="absolute -inset-4 bg-gradient-radial from-yellow-400/5 to-transparent 
